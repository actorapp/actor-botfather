...
interface I18NTrait {
    var language: String
    fun pickLocale(supported: List<String>, usersLocales: Array<String>): String
    fun initLocalize(fileName: String)
    fun localized(key: String): String
}

fun I18NTrait.initLocalize(name: String, supported: List<String>, usersLocales: Array<String>) {
...
class I18NTraitImpl : I18NTrait {
    ...
    override fun pickLocale(supported: List<String>, usersLocales: Array<String>): String {
